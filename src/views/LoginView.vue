<template>
  <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="bg-white p-3 md:p-4 rounded-lg shadow-md">
          ...
          <ul class="space-y-2 md:space-y-3 text-left text-gray-700">
            <li class="flex items-center text-sm md:text-base">
              <svg class="w-5 h-5 md:w-6 md:h-6 text-blue-500 mr-2 md:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Login Form Section -->
    <div class="md:w-1/2 bg-gray-50 flex items-center justify-center p-4 md:p-12">
      <div class="w-full max-w-md bg-white rounded-xl shadow-2xl p-6 md:p-8 border border-gray-100">
        ...
        <form @submit.prevent="login" class="space-y-4 md:space-y-5">
          <div>
            ...
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="h-4 w-4 md:h-5 md:w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex items-center justify-between text-sm md:text-base">
            ...
            <div>
              <a href="#" class="text-xs md:text-sm text-blue-600 hover:text-blue-500">
                Forgot password?
              </a>
            </div>
          </div>
          ...
          <button 
            type="submit" 
            class="w-full bg-blue-600 text-white py-2 md:py-3 text-sm md:text-base rounded-md hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          >
            Sign In
          </button>
