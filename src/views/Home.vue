        ...
        <div class="w-full md:w-96">
          <div class="relative">
            <input 
              ...
              v-model="searchQuery"
              class="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
...
export default {
  ...
  data() {
    return {
      ...
      selectedDepartment: '',
      currentPage: 0, // Tracks the current set of 3 activities
      studentPage: 0, // Tracks the current set of 5 students
      pageSize: 3,    // Number of activities per page
      studentPageSize: 4, // Number of students per page
      keyStatistics: [
      ...
      // Add chart instances to data to manage destruction
  ...
  beforeUnmount() {
    // Clean up charts when the component is destroyed
    this.destroyCharts()
  },
  methods: {
    destroyCharts() {
