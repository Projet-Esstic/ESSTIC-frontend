<template>
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        <label for="student-select" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Select Student</label>
        <select 
          id="student-select"
    ...
    <div v-if="paginatedRegistrations.length > 0" class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          <tr v-for="reg in paginatedRegistrations" :key="`${reg.studentId}-${reg.courseId}`" class="hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div class="flex-shrink-0 h-8 w-8 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full" 
                :class="reg.status === 'Active' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm">
              ...
              <button 
                @click="updateRegistrationStatus(reg)" 
    ...
    <div v-if="filteredRegistrations.length > 0" class="mt-6 flex justify-between items-center">
      <div class="text-sm text-gray-700 dark:text-gray-300">
        Showing <span class="font-medium">{{ paginationStart }}</span> to <span class="font-medium">{{ paginationEnd }}</span> of <span class="font-medium">{{ filteredRegistrations.length }}</span> registrations
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6">
        ...
        <div v-if="selectedRegistration" class="space-y-6">
          <div class="flex items-center justify-center mb-6">
            <div class="h-20 w-20 bg-primary-light dark:bg-primary-dark opacity-20 rounded-full flex items-center justify-center">
              <span class="text-3xl font-bold text-primary-light dark:text-primary-dark">{{ selectedRegistration.courseCode.substring(0, 2) }}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 gap-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <div class="grid grid-cols-2 gap-y-3">
                ...
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.courseCode }}</div>
                
                <div class="text-sm text-gray-500 dark:text-gray-400">Course Name</div>
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.courseName }}</div>
                
                <div class="text-sm text-gray-500 dark:text-gray-400">Credits</div>
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.credits }}</div>
                
                <div class="text-sm text-gray-500 dark:text-gray-400">Semester</div>
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">Semester {{ selectedRegistration.semester }}</div>
              </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <div class="grid grid-cols-2 gap-y-3">
                ...
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.studentId }}</div>
                
                <div class="text-sm text-gray-500 dark:text-gray-400">Name</div>
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.studentName }}</div>
                
                <div class="text-sm text-gray-500 dark:text-gray-400">Department</div>
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.departmentName }}</div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-2 gap-y-3">
                ...
                <div class="text-sm font-medium">
                  <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full" 
                    :class="selectedRegistration.status === 'Active' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 
                ...
                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ selectedRegistration.registrationDate }}</div>
              </div>
            </div>
          </div>
          ...
          <div class="flex justify-end space-x-3 pt-4">
            ...
            <button 
              @click="updateRegistrationStatus(selectedRegistration)" 
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full p-6">
        ...
        <div v-if="selectedRegistration" class="mb-6">
          <p class="text-gray-600 dark:text-gray-400 mb-4">
            Update the registration status for <strong>{{ selectedRegistration.courseName }}</strong> ({{ selectedRegistration.courseCode }}) by <strong>{{ selectedRegistration.studentName }}</strong>
          </p>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6">
        ...
        <form @submit.prevent="saveNewRegistration" class="space-y-4">
          ...
          <div>
            ...
            <select 
              v-model="registrationForm.courseId" 
              class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark bg-white dark:bg-gray-800 text-text-light dark:text-text-dark"
              required
